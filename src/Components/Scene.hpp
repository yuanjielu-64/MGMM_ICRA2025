...
namespace Antipatrea {
    ...
    public:
        ...
        std::vector<std::vector<std::vector<double>>> m_mmPredictedPaths;
        std::vector<double> m_mmValidPaths;
        std::vector<double> m_mmMatrix;
        std::vector<std::vector<double>> m_mmCors;
        int mmNrPaths;
