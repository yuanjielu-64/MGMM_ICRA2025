...
// scene
        ...
        const char KW_ObstaclesPolygonsID[] = "ObstaclesPolygonsID";
        const char KW_UseSceneForGrid[] = "UseSceneForGrid";
        const char KW_MGMMPredictLabel[] = "MGMMPredictLabel";
        const char KW_ObstacleId[] = "UseObstacle";
        const char KW_UseGrid[] = "UseGrid";
        const char KW_TopNumber[] = "TopNumber";
