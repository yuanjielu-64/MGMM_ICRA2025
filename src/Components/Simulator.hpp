...
namespace Antipatrea {
    ...
    public:
        ...
        void LoadPredictModels(void) {
            LoadModel(m_modelPredictRuntime, modelPath, "model/", "time");
            LoadModel(m_modelPredictDistance, modelPath, "model/", "distance");
            LoadModel(m_modelPredictRuntimeShortest, modelPath, "model/", "timeShortest");
            LoadModel(m_modelPredictDistanceShortest, modelPath, "model/", "distanceShortest");
        }

        double PredictRuntime(const double x1, const double y1, const double x2, const double y2) {
            return 0.0; //predictRuntime(x1, y1, x2, y2, m_modelPredictRuntime);
        }

        double PredictDistance(const double x1, const double y1, const double x2, const double y2) {
            return 0.0; //predictDistance(x1, y1, x2, y2, m_modelPredictDistance);
        }

        double PredictCost(const double x1, const double y1, const double x2, const double y2) {
            return 0.0;
        }

        PredictorHandle m_modelPredictRuntime;
        PredictorHandle m_modelPredictDistance;
        PredictorHandle m_modelPredictRuntimeShortest;
        PredictorHandle m_modelPredictDistanceShortest;
