...
const double GRID_MIN[] = {-40, -40, 0};
const double GRID_MAX[] = { 40,  40, 20};
const int GRID_DIMS[] = {64, 64, 16};
...
const double GRAPHICS_PERSPECTIVE_NEAR_PLANE = 100;
const double GRAPHICS_PERSPECTIVE_FAR_PLANE = 10000;
...
const double GRAPHICS_FONT_SIZES[] = {2, 2, 4};
